	...
	<div class="">
		...
		>
			...
			>
				...
				<p class="ml-4 text-brand-lightGrey">I Have Read And Agree To The Terms And Conditions</p>
			</div>
			<PrimaryButton type="button" class="!w-full !py-4"> Play Now </PrimaryButton>
		</div>
	</div>
</template>
