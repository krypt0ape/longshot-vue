...
const { loading, error, data: categoryData } = useApi("post", "/contentful/entries", {
...
const categories = computed(() => {
	...
	const items =  reduce(categoryData.value.items, (result, item)=>{
		result.push({
...
<template>
	<div>
		<PostListTabs heading="Blog" slug="/blog/category" :categories="categories" />
	</div>
</template>