...
<template>
  ...
  >
    <div
      ...
      class="scrollbar-thumb-brand-grey scrollbar-track-transparent scrollbar-thin scrollbar-track-rounded-full h-8 overflow-x-hidden"
    >
      <div
      ...
      >
        ...
        <div class="">
          <template v-if="casinoActive">
            <AppSidebarCasinoPrimary />
            <AppSidebarCasinoSecondary />
            <AppSidebarCasinoProviders
          /></template>
          <template v-if="sportsActive"
