  ...
  <div class="app-header flex bg-brand-accentBgHeader ">
    <div v-if="store.open" class="w-[250px] bg-brand-bodyBg flex items-center justify-between px-4 transition">
      ...
      <RouterLink to="/sports/home">
        <PrimaryButton class="px-[14px] py-[14px]"   v-if="sportsActive">Sports</PrimaryButton>
        <NeutralButton class="px-[14px] py-[14px]" v-else>Sports</NeutralButton>
      </RouterLink>
      <RouterLink to="/casino/home">
        <SecondaryButton class="px-[14px] py-[14px]"  v-if="casinoActive">Casino</SecondaryButton>
        <NeutralButton class="px-[14px] py-[14px]"  v-else>Casino</NeutralButton>
      </RouterLink>
    </div>
