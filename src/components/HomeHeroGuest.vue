...
<template>
	<div class="text-center relative z-50   lg:ml-[50px] sm:w-[350px] xl:w-[430px]">
		...
		>
			...
			<PrimaryButton @click="signup" class="py-[16px] text-lg">Create an Account</PrimaryButton>
			<div class="flex items-center justify-center">
				<span class="bg-[#303D4B] h-[1px] w-[108px]">&nbsp;</span>
				<p class="px-6 text-brand-grey py-2">or</p>
				<span class="bg-[#303D4B] h-[1px] w-[108px]">&nbsp;</span>
			</div>
			<NeutralButton @click="login" class="py-[16px] px-[60px] text-lg">Sign In</NeutralButton>
		</div>
	</div>
</template>
<style>
